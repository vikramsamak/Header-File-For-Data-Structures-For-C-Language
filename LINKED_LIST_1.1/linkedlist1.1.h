...
//NODE_INSERT_AT_END//
void nodeinsertatend()
{   
    int num;
    printf("\nEnter Data To Insert At The End Of Linked List: ");
    scanf("%d",&num);
    struct node *fnNode, *tmp;
    fnNode = (struct node*)malloc(sizeof(struct node));
    if(fnNode == NULL)
...
void nodeinsertatmiddle()
{   
    int num,pos;
    printf("\nEnter Data And Position To Enter The Data:  ");
    scanf("%d%d",&num,&pos);
    int i;
    struct node *fnNode, *tmp;
    fnNode = (struct node*)malloc(sizeof(struct node));
...
{   
    int pos;
    printf("\nEnter The Postion From Which You Want to Delete Data: ");
    scanf("%d",&pos);
    int i;
...
//SEARCHING_OPERATION//
void searchfromlinkedlist()
{
    int data;
    printf("\nEnter Data To Search From Linked List: ");
    scanf("%d",&data);
    int i,flag;
    i=0;
    ptr=stnode;
